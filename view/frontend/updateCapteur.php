...
<div class="main-wrapper">
    <div class="container">
        <div class="form-header">
            <h1><i class="fas fa-edit"></i> Modifier le Capteur</h1>
            <span class="capteur-badge"># <?= htmlspecialchars($capteurData['id_capteur']) ?></span>
            <div class="header-divider"></div>
            <p class="subtitle">Modifiez les informations du capteur</p>
        </div>
        ...
        <form method="POST" id="capteurForm" novalidate>
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="unite" id="unite" class="form-control" value="<?= htmlspecialchars($capteurData['uniteCapteur']) ?>" placeholder="Automatique selon la catégorie" readonly required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="emplacement" id="emplacement" class="form-control" value="<?= htmlspecialchars($capteurData['emplacement']) ?>" placeholder="Ex : Serre A - Zone 1" maxlength="100" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="dateInstallation" id="dateInstallation" class="form-control" value="<?= htmlspecialchars($capteurData['dateInstallation']) ?>" required>
...
window.addEventListener('DOMContentLoaded', function() {
    Object.keys(fields).forEach(field => {
        if (field !== 'unite' && fields[field].value) {
            validate(field);
        }
    });
    updateProgress();
