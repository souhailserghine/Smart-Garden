...
$commentCounts = [];
// CHARGER TOUS LES COMMENTAIRES POUR CHAQUE PUBLICATION
$allComments = [];
...
<body class="newsfeed">
                    ...
                    <div class="col-md-6 second-section" id="page-content-wrapper">
                        ...
                        <?php if (isset($_GET['success'])): ?>
                            <div class="alert alert-success alert-dismissible fade show">
                                ...
                                if ($_GET['success'] == 4) echo "Modification effectuée avec succès!"; // CHANGEMENT ICI
                        ...
                        <!-- AJOUT: Messages pour la suppression des commentaires -->
                                                ...
                                                <?php foreach ($allComments[$pub['idPublication']] as $comment): ?>
                                                    <div class="comment-item" id="comment-<?= $comment->getIdCommentaire() ?>">
                                                        <div class="comment-header d-flex justify-content-between align-items-center">
                                                            ...
                                                            <?php if ($comment->getIdUtilisateur() == $idUtilisateur): ?>
                                                                <div class="comment-actions">
                                                                    ...
                                                                    <!-- MODIFICATION: Suppression du paramètre publicationId -->
                                                        ...
                                                        <div class="comment-edit-form" id="edit-form-<?= $comment->getIdCommentaire() ?>" style="display: none;">
                                                            <form method="POST" action="update_comment.php" class="mt-2">
                                                                <input type="hidden" name="idCommentaire" value="<?= $comment->getIdCommentaire() ?>">
                                                                <input type="hidden" name="idPublication" value="<?= $pub['idPublication'] ?>">
                                                                <div class="input-group">
                                                                    <input type="text" name="contenuCommentaire" class="form-control" 
                                    ...
                                    <div class="publication-actions">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <a href="delete.php?id=<?= $pub['idPublication'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette publication ?')">
                                                    🗑️ Supprimer
                                                </a>
                                            </div>
                                            <div class="col-md-6 text-right">
    ...
    <script>
        ...
        function enableCommentEdit(commentId) {
            // Masquer le texte et afficher le formulaire d'édition
        ...
        // MODIFICATION: Fonction pour supprimer un commentaire (paramètre simplifié)
        function deleteComment(commentId) {
            if (confirm('Êtes-vous sûr de vouloir supprimer ce commentaire ?')) {
                // Rediriger vers la page de suppression avec le bon paramètre
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (openCommentsId) {
                // Ouvrir les commentaires de la publication
