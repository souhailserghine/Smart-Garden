...
try {
    ...
    if ($action === 'add') {
        ...
        // Insérer dans suggestionplante - SANS type_plante, description ni image
        $query = "INSERT INTO suggestionplante 
                  (id_utilisateur, nom_plante, niveau_humidite, besoin_eau, etat_sante, date_suggestion, statut) 
                  VALUES ($idUtilisateur, '$nomPlante', $niveauHumidite, $besoinEau, '$etatSante', NOW(), 'En attente')";
