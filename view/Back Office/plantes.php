        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-2 mt-2">
                    <h3 style="font-size: 1.2rem;padding-left: 20px; color: #2ecc71;"><img src="img/logo-64x64.png" alt="Logo" class="me-2" style="width: 32px; height: 32px;">SmartGarden</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="plantes.html" class="nav-item nav-link active"><i class="fa fa-leaf me-2"></i>Plantes</a>
...
<a href="add.php" class="nav-item nav-link active"><i class="fa fa-seedling me-2"></i>Ajouter Plante</a>
...
<table class="table table-striped table-bordered mt-4">
    ...
    <tbody>
        <?php foreach($listePlantes as $plante) { ?>
            <tr>
                <td><?php echo $plante['nom_plante']; ?></td>
                ...
                <td>
                    <a href="modifierPlante.php?id=<?php echo $plante['id_plante']; ?>" 
                       class="btn btn-warning btn-sm">
                        Modifier
                    </a>

                    <a href="supprimerPlante.php?id=<?php echo $plante['id_plante']; ?>" 
