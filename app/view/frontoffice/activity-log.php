...
$id = $_SESSION['user_id'];
$editUser = $controller->afficherParId($id);

$historiques = $historiqueC->afficherParUtilisateur($id);
                ...
                <nav id="navbar-main" class="navbar navbar-expand-lg shadow-sm sticky-top">
                    <ul class="navbar-nav mr-5" id="main_menu">
                        ...
                        <li class="nav-item nav-icon">
                            <a href="settings.php" data-toggle="tooltip" data-placement="bottom" data-title="Settings" class="nav-link"><img src="./assets/images/icons/navbar/settings.png" class="nav-settings" alt="navbar icon"></a>
                        </li>
                    </ul>
                </nav>
                        ...
                        <div id="message-frame">
                                ...
                                <div class="message-contacts settings-sidebar">
                                    <ul class="conversations">
                                        ...
                                        <li class="contact setting-active">
                                            <a href="activity-log.php" class="wrap d-flex align-items-center">
                            ...
                            <div class="content">
                                <div class="settings-form p-4">
                                    <h2>Activity Log</h2>
                                    <p class="text-muted mb-4">View your login history and session activity</p>

                                    <h4 class="mb-3">Recent Activity</h4>
                                    <?php if (count($historiques) == 0): ?>
                                        <div class="alert alert-info"> 
                                            <i class='bx bx-info-circle'></i> No activity history found.
                                        </div>
                                    <?php else: ?>
