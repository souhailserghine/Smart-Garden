        ...
        <div class="row newsfeed-size f-width">
            <div class="col-md-12 message-right-side">
                <nav id="navbar-main" class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
                    ...
                    <div class="dropdown nav-item nav-quick-links" data-toggle="tooltip" data-placement="bottom" title="Quick Links">
                        <a href="#" class="nav-link nav-links" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class='bx bx-align-middle'></i></a>
                        <div class="dropdown-menu nav-drop">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="profile.php" class="sidebar-item"><i class='bx bx-news text-primary'></i> Profile</a>
                                    <a href="#" class="newsfeedListicon"><i class='bx bx-dots-horizontal-rounded'></i></a>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="publications.php" class="sidebar-item"><i class='bx bx-envelope text-primary'></i> Publications</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="plantes.php" class="sidebar-item"><i class='bx bx-group text-primary'></i> Plantes</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="evenements.php" class="sidebar-item"><i class='bx bx-calendar text-primary'></i> Evenements</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="find-friends.php" class="sidebar-item"><i class='bx bxs-user-detail text-primary'></i> Find Friends</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="matches.php" class="sidebar-item"><i class='bx bx-carousel text-primary'></i> Matches</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="teams.php" class="sidebar-item"><i class='bx bxl-slack-old text-primary'></i> Argon For Teams</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="news.php" class="sidebar-item"><i class='bx bx-file text-primary'></i> News</a>
                                    <span class="badge badge-primary badge-pill"><i class='bx bx-chevron-right'></i></span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <a class="navbar-brand mr-lg-5" href="index.php"><img src="./assets/images/logo-32x32.png" class="mr-3" alt="Logo"> Argon</a>
                        ...
                        <ul class="navbar-nav mr-5">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right nav-drop">
                                    ...
                                    <a class="dropdown-item" href="settings.php"><i class='bx bx-cog mr-2'></i> Settings</a>
                                    <div role="separator" class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="logout.php"><i class='bx bx-undo mr-2'></i> Logout</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="message-sidepanel">
                                <div class="message-contacts">
                                    <ul class="conversations">
                                        ...
                                        <li class="contact">
                                            <a href="settings.php" class="wrap d-flex align-items-center">
                                        ...
                                        <li class="contact">
                                            <a href="settings-contact.php" class="wrap d-flex align-items-center">
                                        ...
                                        <li class="contact">
                                            <a href="settings-password.php" class="wrap d-flex align-items-center">
                                        ...
                                        <li class="contact">
                                            <a href="settings-fingerprint.php" class="wrap d-flex align-items-center">
                                                <div class="meta"></div>
                                                <p><i class='bx bx-fingerprint'></i> Fingerprint Lock</p>
                                            </a>
                                        </li>
                                        <li class="contact">
                                            <a href="settings-location.php" class="wrap d-flex align-items-center">
                                                <div class="meta"></div>
                                        ...
                                        <li class="contact setting-active">
                                            <a href="settings-billing-method.php" class="wrap d-flex align-items-center">
                                                <div class="meta"></div>
                            ...
                            <div class="content" style="overflow: auto;">
                                <div class="settings-form p-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#" class="btn btn-primary">Add New Billing Method</a>
                                    </div>
                                    <div class="login-sessions">
                                        <h5 class="mb-3 mt-4 text-muted">Primary Account Billing Method</h5>
                                        <p class="text-muted">This is the primary billing method for your account. Iy'll be the default we use to charge you for future transactions.</p>
                                        <div class="location-card">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img class="mr-4 float-left" src="./assets/images/icons/visa.png" alt="Paymant image">
                                                    <div>
                                                        <h5 class="mt-0 fs-1">411111******1111</h5>
                                                        <span class="text-muted">Expire 12/2013</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-3 text-right">
                                                    <a href="#" class="btn"><i class='bx bxs-trash-alt'></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="location-card">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <img class="mr-4 float-left" src="./assets/images/icons/paypal.png" alt="Paymant image">
                                                    <div>
                                                        <h5 class="fs-1">Pay Pal</h5>
                                                        <span class="text-muted">bt_buyer_us@paypal.com</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="billing-address">
                                                ...
                                                <div class="col-md-3 text-right">
                                                    <a href="#" class="btn btn-light">Set as Primary</a>
                                                    <a href="#" class="btn"><i class='bx bxs-trash-alt'></i></a>
                                                </div>
                                            </div>
                                        </div>
