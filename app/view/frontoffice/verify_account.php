...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (!$email || !$token) {
        ...
        if (!$user) {
            ...
            if ($controller->verifierEmail($email)) {
...
<head>
    ...
    <title>Verify Account - SmartGarden</title>
    ...
    <div class="row ht-100v flex-row-reverse no-gutters">
        <div class="col-md-6 d-flex justify-content-center align-items-center">
            <div class="signup-form">
                ...
                <?php else: ?>
                    <div class="text-center mt-3">
                        <a href="sign-in.php" class="btn btn-outline-primary sign-up">Go to Sign In</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        <div class="col-md-6 auth-bg-image d-flex justify-content-center align-items-center">
            <div class="auth-left-content mt-5 mb-5 text-center">
                ...
                <div class="text-white mt-5 mb-5">
                    <h2 class="create-account mb-3">Verify Account</h2>
                    <p>Activate your SmartGarden account</p>
                </div>
            </div>
        </div>
    </div>
