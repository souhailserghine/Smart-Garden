                    ...
                    <div class="col-md-10 second-section" id="page-content-wrapper">
                        ...
                        <div class="jumbotron groups-banner">
                            <div class="container group-banner-content">
                                <h1 class="jumbotron-heading mt-auto"><img src="./assets/images/icons/theme/group-white.png" alt="Welcome to groups"> Groups</h1>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6">
                                    <div class="card group-card shadow-sm">
                                        <img src="./assets/images/groups/group-1.png" class="card-img-top group-card-image" alt="Group image">
                                        <div class="card-body">
                                            <h5 class="card-title">Smart Garden <img src="./assets/images/theme/verify.png" width="15px" class="verify" alt="Group verified"></h5>
                                            <p class="card-text">10k Members 20+ post a week</p>
                                            <a href="#" class="btn btn-quick-link join-group-btn border w-100" data-toggle="modal" data-target="#exampleModal">Join</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="card group-card shadow-sm">
                                        <img src="./assets/images/groups/group-3.jpg" class="card-img-top group-card-image" alt="Group image">
                                        <div class="card-body">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="card group-card shadow-sm">
                                        <img src="./assets/images/groups/group-4.jpg" class="card-img-top group-card-image" alt="Group image">
                                        <div class="card-body">
                        ...
                        <div class="groups py-3 px-4 mt-3">
                            <div class="card-head d-flex justify-content-between">
                                <h5 class="mb-4">Friends Groups</h5>
                                <a href="#" class="btn btn-link">See All</a>
                            </div>
                            <div class="row">
                        ...
                        <hr class="my-5">
                        <div class="groups py-3 px-4 mt-3 mb-4" id="scroll-div-bootom">
                            <div class="card-head d-flex justify-content-between">
                                <h5 class="mb-4">Find By Categories</h5>
                                <button class="btn btn-link" id="btn-to-scroll-bottom" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="group-category-1 group-category-2">Open</button>
                            </div>
                            <div class="row">
