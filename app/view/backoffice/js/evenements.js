...
function initMap() {
    ...
    L.Control.geocoder({
        ...
        geocoder: new L.Control.Geocoder.Nominatim({
            serviceUrl: '/website/Smart-Garden/;qrzq/proxy-nominatim.php'
        })
...
function reverseGeocode(latlng) {
    fetch(`/website/Smart-Garden/;qrzq/proxy-nominatim.php?lat=${latlng.lat}&lon=${latlng.lng}`)
        .then(r => r.json())
        .then(data => {
...
const loadCategories = async () => {
    try {
        const r = await fetch('/website/Smart-Garden/;qrzq/categories.php?action=list');
...
const loadEvents = async () => {
    ...
    try {
        console.log('Fetching from:', '/website/Smart-Garden/;qrzq/events.php?action=list');
        const r = await fetch('/website/Smart-Garden/;qrzq/events.php?action=list');
...
document.getElementById('eventForm').onsubmit = async e => {
    ...
    const url = id ? `/website/Smart-Garden/;qrzq/events.php?action=update&id=${id}` : `/website/Smart-Garden/;qrzq/events.php?action=create`;
...
window.confirmDelete = async (id) => {
    ...
    try {
        const response = await fetch(`/website/Smart-Garden/;qrzq/events.php?action=delete&id=${id}`, { method: 'POST' });
        const result = await response.json();
