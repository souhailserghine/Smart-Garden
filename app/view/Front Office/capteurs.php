                        ...
                        <div class="mb-3">
                            <div class="btn-group d-flex">
                                <a href="index.php" class="btn btn-quick-links mr-3 ql-active">
                                    <img src="./assets/images/icons/theme/speech.png" class="mr-2" alt="quick links icon">
                                    <span class="fs-8">Speech</span>
                                </a>
                                <a href="messages.php" class="btn btn-quick-links mr-3">
                                    <img src="./assets/images/icons/theme/listen.png" class="mr-2" alt="quick links icon">
                                    <span class="fs-8">Listen</span>
                                </a>
                                <a href="watch.php" class="btn btn-quick-links">
                                    <img src="./assets/images/icons/theme/watch.png" class="mr-2" alt="quick links icon">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left post-dropdown-menu">
                                                    ...
                                                    <a href="#" class="dropdown-item" aria-describedby="snoozePost">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <span class="fs-9">Snooze <?php echo $_SESSION['user_name']; ?> for 30 days</span>
                    ...
                    <div class="col-md-3 third-section">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="weather-quick d-flex justify-content-center align-items-center my-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="forecast-day text-center">
                                                <span class="text-muted d-block fs-8">Fri</span>
                                                <img src="./assets/images/icons/weather/sun.png" class="my-1" width="30" alt="Weather icon">
                                                <div class="forecast-between d-flex justify-content-between">
                                                    <span class="text-primary">28&deg;</span>
                                                    <span class="text-muted">15&deg;</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="forecast-day text-center">
                                                <span class="text-muted d-block fs-8">Sat</span>
                                                <img src="./assets/images/icons/weather/cloudy-sunny-winds.png" class="my-1" width="30" alt="Weather icon">
                                                <div class="forecast-between d-flex justify-content-between">
                                                    <span class="text-primary">19&deg;</span>
                                                    <span class="text-muted">10&deg;</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="forecast-day text-center">
                                                <span class="text-muted d-block fs-8">Sun</span>
                                                <img src="./assets/images/icons/weather/cloud-bolt.png" class="my-1" width="30" alt="Weather icon">
                                                <div class="forecast-between d-flex justify-content-between">
                                                    <span class="text-primary">22&deg;</span>
                                                    <span class="text-muted">17&deg;</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="forecast-day text-center">
                                                <span class="text-muted d-block fs-8">Mon</span>
                                                <img src="./assets/images/icons/weather/rainy-day.png" class="my-1" width="30" alt="Weather icon">
                                                <div class="forecast-between d-flex justify-content-between">
                                                    <span class="text-primary">25&deg;</span>
                                                    <span class="text-muted">18&deg;</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
